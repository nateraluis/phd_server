...
def plot_nodes_by_cc(cities, layers, colors, shapes, path_plot):
    ...
    ylabel = fig.text(-0.01, 0.5, 'Normalized Size by Total Nodes', va='center', ha='center', rotation='vertical', fontsize=12)
    fig.savefig(path_plot+'{}_Cities_NodeConnectedComponent_Normalized_TotalNodes.png'.format(now.date()),dpi=300, bbox_inches='tight',bbox_extra_artists=[title, xlabel, ylabel])
